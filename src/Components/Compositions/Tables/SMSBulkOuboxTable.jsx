...
const SMSBulkOuboxTable = ({ columns, data, tableTitle, tableHeaderAction, loading, handlePagination,meta }) => {
...
SMSBulkOuboxTable.defaultProps = {
  handlePagination: () => false,
  paginationMeta: {}
}

export default SMSBulkOuboxTable;
